<div class="max-w-5xl mx-auto my-16 border border-slate-200 rounded-xl overflow-hidden">
    <div class="h-[600px] bg-gradient-to-t from-slate-100 p-6 flex space-y-1.5 overflow-scroll flex-col-reverse">
    ...
    <form wire:submit="send" class="bg-slate-100 p-3 border-t border-slate-200 flex space-x-2">
        <div class="bg-white rounded-full grow relative flex items-center h-10 focus-within:ring-2 ring-inset ring-blue-500">
            <input class="bg-transparent rounded-full grow px-4 py-2 text-sm h-10 focus:outline-0" placeholder="Enter case to summarize (e.g. GR. 101083 Oposa v. Factoran)" wire:model="body" />
            <button class="bg-slate-800 text-slate-50 rounded-3xl text-sm font-medium size-10 flex items-center justify-center">
                <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4">
